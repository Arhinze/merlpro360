...
function check_mail_status($mail_xyz) {
    if (!$mail_xyz) {
        ...
        echo <<<HTML
            <div style="display:block;position:fixed;padding:15px;background-color:#0a9396;color:#fff;border:1px solid #fff;border-radius:9px;box-shadow:3px 3px 3px 0 #888;width:fit-content;height:fit-content;top:15%;left:12%;z-index:9">
